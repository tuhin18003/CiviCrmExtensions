 ...
 */
class CRM_SbLocationBased_Form_SearchBuilderExt extends CRM_Contact_Form_Search {
  ...
  public function preProcess() {
    $this->set('searchFormName', 'SearchBuilderExt');

    $this->set('context', 'SearchBuilderExt');
    parent::preProcess();
  ...
  public function buildQuickForm() {
    ...
    CRM_Core_Resources::singleton()
      ->addScriptFile('com.cs.sblocationbased', 'templates/CRM/SbLocationBased/Form/SearchBuilderExt.js', 1, 'html-header')
      ->addSetting(array(
        'searchBuilder' => array(
    ...
    CRM_SbLocationBased_Library_FilterSearchBuilder_MappingFilter::buildMappingForm($this, 'Search Builder', $mappingId, $this->_columnCount, $this->_blockCount);
  ...
  public function addRules() {
    $this->addFormRule(array('CRM_SbLocationBased_Form_SearchBuilderExt', 'formRule'), $this);
  }
      ...
      if (!$v[1]) {
        ...
        elseif (substr($v[0], 0, 7) === 'do_not_' or substr($v[0], 0, 3) === 'is_') {
          ...
          if (substr($v[0], 0, 7) == 'custom_') {
            ...
            $type = isset($fields[$fieldKey]['data_type']) ? $fields[$fieldKey]['data_type'] : '';
...
//    civicrm_api3_contact_proximity($this->_params);
